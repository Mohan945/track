...
# Database credentials (HIDDEN FROM OUTPUT)
DB_USER="DBSNMP"
DB_PASS="c0mplacent"  # Will not appear in logs
...
for DB_NAME in "${DB_NAMES[@]}"; do
    ...
    #############################################
    # Execute SQL script (HIDE CREDENTIALS)     #
    #############################################
    echo "[$(date)] Executing lock script for $DB_NAME" | tee -a "$LOG_FILE"

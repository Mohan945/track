...
# Using -S "content-type=text/html" sets the Content-Type header so that
# the HTML is rendered inline rather than attached.
echo "$MAIL_BODY" | mailx -S "content-type=text/html" -s "Today's Locked Accounts Report" "$RECIPIENT"
